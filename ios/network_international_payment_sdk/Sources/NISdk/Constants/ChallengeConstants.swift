...
//  NISdk
//
//  Created by Johnny Peter on 19/05/22.
//  Copyright © 2022 Network International. All rights reserved.
//

struct ChallengeConstants {
    static let MC_MTF_DIRECTORY_SERVER_KEY_ID = "de7655be-3d6f-4802-9d68-c36a9d23e71c"
    static let MC_MTF_DIRECTORY_SERVER_ID = "SANDBOX_DS"
    static let MC_MTF_PROVIDER_NAME = "Sandbox DS"
    
    static let MC_MTF_DIRECTORY_SERVER_PUBLIC_KEY =
