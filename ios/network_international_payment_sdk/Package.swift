...
let package = Package(
    ...
    platforms: [
        .iOS(.v14)  // NISdk 6.1.1 requires iOS 14+
    ],
    products: [
        .library(
    ...
    dependencies: [
        ...
        //   .package(url: "https://github.com/network-international/payment-sdk-ios.git", from: "6.1.1")
    ...
    targets: [
        ...
        //   https://github.com/network-international/payment-sdk-ios (tag v6.1.1)
